...
$(document).ready(function() {
	...
	// Require jasmine.js
	// =================================================================
	$(".demo-add-jasmineradio").on('post-body.bs.table', function () {
		$(this).find('input:radio').wrap('<label class="form-radio form-icon"></label>');
		$(this).find('.form-radio').jasmineCheck();
	});
