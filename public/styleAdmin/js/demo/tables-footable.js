...
$(window).on('load', function() {
	...
	$('#demo-btn-addrow').click(function() {
		...
		var newRow = '<tr><td><button class="btn btn-danger fa fa-trash"></button></td><td>Adam</td><td>Doe</td><td>Traffic Court Referee</td><td>22 Jun 1972</td><td><span class="label label-table label-success">Active</span></td></tr>';
