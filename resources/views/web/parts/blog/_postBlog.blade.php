        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-9">
                    ...
                    <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=https://guiaceliaca.com.ar/blog/{{$post->slug}}" target="_blank" rel="noopener" aria-label="Share on Facebook">
                    ...
                    <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text={!! Str::limit($post->body,85) !!}&amp;url=https://guiaceliaca.com.ar/blog/{{$post->slug}}" target="_blank" rel="noopener" aria-label="Share on Twitter">
                    ...
                    <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url=https://guiaceliaca.com.ar/blog/{{$post->slug}}&amp;media=https://guiaceliaca.com.ar/blog/{{$post->slug}}&amp;description={!! Str::limit($post->body,130) !!}" target="_blank" rel="noopener" aria-label="Share on Pinterest">
