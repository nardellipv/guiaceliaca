        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-9">
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://twitter.com/intent/tweet/?text={!! Str::limit($post->body,85) !!}&amp;url=https://guiaceliaca.com.ar/blog/{{$post->slug}}"
                    ...
                    <a class="resp-sharing-button__link"
                       href="https://pinterest.com/pin/create/button/?url=https://guiaceliaca.com.ar/blog/{{$post->slug}}&amp;media=https://guiaceliaca.com.ar/blog/{{$post->slug}}&amp;description={!! Str::limit($post->body,130) !!}"
