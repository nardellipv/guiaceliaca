                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=https://guiaceliaca.com.ar/{{$commerce->slug}}" target="_blank" rel="noopener" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text={{$commerce->name}}&amp;url=https://guiaceliaca.com.ar/{{$commerce->slug}}" target="_blank" rel="noopener" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url=https://guiaceliaca.com.ar/{{$commerce->slug}}&amp;media=https://guiaceliaca.com.ar/{{$commerce->slug}}&amp;description={{$commerce->name}}" target="_blank" rel="noopener" aria-label="">
