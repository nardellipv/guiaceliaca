            ...
            <div class="row">
                <div class="col-sm-8 col-md-9">
                    <div class="blog-list blog-detail">
                        ...
                        <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=https://guiaceliaca.com.ar/recetas/{{$recipe->slug}}" target="_blank" rel="noopener" aria-label="Share on Facebook">
                        ...
                        <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=Consulta muchas mas recetas en guiaceliaca.com.ar&amp;url=https://guiaceliaca.com.ar/recetas/{{$recipe->slug}}" target="_blank" rel="noopener" aria-label="Share on Twitter">
                        ...
                        <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url=https://guiaceliaca.com.ar/recetas/{{$recipe->slug}}&amp;media=https://guiaceliaca.com.ar/recetas/{{$recipe->slug}}&amp;description=Consulta muchas mas recetas en guiaceliaca.com.ar" target="_blank" rel="noopener" aria-label="Share on Pinterest">
                            <div class="resp-sharing-button resp-sharing-button--pinterest resp-sharing-button--large"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
                                ...
                                </div>Compartir en Pinterest</div>
                        </a>
